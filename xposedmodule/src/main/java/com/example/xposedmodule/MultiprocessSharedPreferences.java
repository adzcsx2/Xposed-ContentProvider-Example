...
//		at com.qihoo.storager.MultiprocessSharedPreferences.a(AppStore:452)
    ...
    public String getString(String key, String defValue) {
        String data = (String) getValue(PATH_GET_STRING, key, defValue);
        Log.e("TAG", data + "\t" + key + "\t" + defValue);
        return data;
    }
    ...
    private Object getValue(String pathSegment, String key, Object defValue) {
        ...
        if (!mIsSafeMode && checkInitAuthority(mContext)) { // 如果设备处在“安全模式”，返回defValue；
            ...
            if (cursor != null) {
                ...
                if (bundle != null) {
                    v = bundle.get(KEY);
                    String a = (String) bundle.get("value");
                    Log.e("aaa", a);
                    bundle.clear();
                }
                cursor.close();
        ...
        if (DEBUG) {
            Log.e(TAG, "getValue.mName = " + mName + ", pathSegment = " + pathSegment + ", key = " + key + ", defValue = " + defValue);
        }
